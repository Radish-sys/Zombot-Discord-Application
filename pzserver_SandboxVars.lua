SandboxVars = {
    ...
    SIMBAproduz_TSY = {
        ...
        ChaseScreechChance = 50,
        -- Min: 0.00 Max: 0.10 Default: 0.03
        ChaseCooldownHours = 0.03,
        -- Min: 0.10 Max: 3.00 Default: 1.00
        GlobalVolume = 1.0,
        -- Min: 0.01 Max: 1.00 Default: 0.08
        FarVolume = 0.08,
        -- Min: 0.10 Max: 3.00 Default: 1.00
        NearVolume = 1.0,
        -- Min: 10 Max: 300 Default: 150
        FarRange = 150,
        -- Min: 50 Max: 400 Default: 220
        MaxProcessDistance = 220,
        -- Min: 1 Max: 20 Default: 6
        TickRate = 6,
        AlertNearbyZombies = true,
        -- Min: 10 Max: 120 Default: 80
        AlertRadius = 80,
        -- Min: 5 Max: 80 Default: 35
        ClusterRadius = 35,
        -- Min: 0.00 Max: 0.10 Default: 0.01
        ClusterCooldownHours = 0.01,
        -- Min: 1 Max: 10 Default: 1
        MaxClusterScreams = 1,
        EnableNearScream = true,
        NearAsWorldSound = false,
    },
    Text = {
